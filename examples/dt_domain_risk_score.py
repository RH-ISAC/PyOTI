...
def main():
    parser = ArgumentParser(
        prog="IrisInvestigate Domain Risk Score",
        description="Check Domaintools Iris Investigate for domain risk score of a given domain",
    )
    parser.add_argument(
        "-d", "--domain", dest="domain", help="domain to check reputation"
    )
